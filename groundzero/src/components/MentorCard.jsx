...
const MentorCard = ({mentor, setOpenCard, setCurrMentor}) => {
  ...
  return (
    <div className="z-50 flex place-items-center items-center justify-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-gray-600/60 backdrop-blur"
